...
public class KriptoAlgorithms {
    ...
    public String code(String message, Long publicKeyN, Long publicKeyC)
    {
        ...
        String secretMessage = secret.toString();
        return secretMessage;
    }

    public String check(String n, String sf, Long publicD, Long publicN)
    {
        Long sfDigit = Long.parseLong(sf);
        Long check = degreeByMod(sfDigit, publicD, publicN);
        //System.out.println("sf:" + check + ":" + oneWayFunction(Long.parseLong(n)));
        if(oneWayFunction(Long.parseLong(n)).toString().equalsIgnoreCase(check.toString()))
            return "true";
        else return "false";
    }
    ...
    public Long oneWayFunction(Long n)
    {
        return degreeByMod(n, 3l, p);
    }
}