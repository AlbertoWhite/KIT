...
public class ClientWindow extends JFrame {
    ...
    public void sendCode()
    {
            ...
            String secretMessage = kriptoAlgorithms.code(Long.parseLong(message), secretC);
            jtaTextAreaMessage.append(secretMessage);
            jtaTextAreaMessage.append("\n");
    }
    public void addPublicKey()
    {
        JLabel publicKey = new JLabel("Public key: " + publicD.toString());
        bottomPanel.add(publicKey, BorderLayout.SOUTH);
        bottomPanel.repaint();
    }
}